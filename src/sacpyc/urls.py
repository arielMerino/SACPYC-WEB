...
urlpatterns = patterns('',
    ...
    url(r'^ValidarAddTipoUtensilio/',Administracion().validarCrearTipoUtensilio),
    url(r'^EditarTipoUtensilio/',Administracion().editarTipoUtensilio),
    url(r'^ValidarEditTipoUtensilio/',Administracion().validarEditarTipoUtensilio),
    url(r'^EliminarTipoUtensilio/',Administracion().eliminarTipoUtensilio),
    url(r'^CrearUtensilio/',Administracion().crearUtensilio),
    url(r'^ValidarCrearUtensilio/',Administracion().validarCrearUtensilio),
